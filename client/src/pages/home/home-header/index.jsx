...
export default function HomeHeader() {
  return (
      ...
      <header className="w-full tablet:w-[95%] relative flex items-end justify-end   mobile:flex-row">
        <div className="w-full   flex flex-col justify-center max-w-[12rem] mobile:max-w-[18rem] absolute left-0   z-[2]">
            <img
              src={mainimg}
              alt=""
              className=" h-[8rem]  tablet:h-[18rem]  laptop:h-[18rem]  deskop:h-[18rem] object-cover  "
            />
            <h1 className="w-full text-center  text-[2rem] mobile:text-[3rem] tablet:text-[4rem] laptop:text-[6rem] deskop:text-[8rem] ">MATEMATİK</h1> 
        </div> 
          <img
            src={headerstudent}
            alt="Header"
