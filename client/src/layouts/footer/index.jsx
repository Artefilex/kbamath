...
export default function Footer() {
  ...
  return (
    <footer className="rounded-md border-1  w-full laptop:max-w-[80%] gap-4 flex-col flex items-center justify-center tablet:my-4 relative  backdrop-blur-md text-white bg-black/80 px-2 py-6 mobile:mb-6">
