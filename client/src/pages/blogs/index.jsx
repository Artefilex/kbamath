      ...
      <main className=" py-2 grid  grid-rows-1 grid-cols-1  mobile:grid-rows-2 mobile:grid-cols-2 w-full gap-3 deskop:grid-rows-3 deskop:grid-cols-3">
        {blogs.map((blog) => (
          ...
          >  
             ...
             <img src={`${import.meta.env.VITE_BASE_URL}/${blog.image}`} alt={blog.header} className="group-hover:scale-105 rounded-md relative z-[1]  w-[20rem] h-[25rem] object-cover duration-700 " />
