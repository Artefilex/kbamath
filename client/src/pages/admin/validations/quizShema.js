...
export const QuizShema = Yup.object().shape({
    title:Yup.string().required("Lütfen Başlık Giriniz").test("is-unique", "Bu başlık zaten kullanılıyor", async function (value) {
      const existingClasses = await getAllItems("quizs");
